...
required this.nurseId,
  ...
  factory AppointmentModel.fromMap(Map<String, dynamic> map) {
    return AppointmentModel(
      ...
      doctorId: int.tryParse(map['doctor_id']?.toString() ?? '0') ?? 0,
      patientId: int.tryParse(map['patient_id']?.toString() ?? '0') ?? 0,
      nurseId: int.tryParse(map['nurse_id']?.toString() ?? '0') ?? 0,
  ...
  factory AppointmentModel.fromJson(Map<String, dynamic> json) {
    return AppointmentModel(
      ...
      nurseId: int.tryParse(json['nurse_id']?.toString() ?? '0') ?? 0,
      isSynced: 1,
